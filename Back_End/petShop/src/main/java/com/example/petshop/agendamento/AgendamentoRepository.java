...
//
<<<<<<< Updated upstream
    @Query("SELECT COUNT(a) FROM Agendamento a WHERE a.funcionario = :funcionario AND a.dataHora = :horario")
=======
//    @Query("SELECT COUNT(a) FROM Agendamento a WHERE a.funcionario = :funcionario AND a.dataHora = :dataHora")
>>>>>>> Stashed changes
